...
import { findAllUsers, findRelevantUsers, findUserById, findUserByName } from "~/server/services/userService";
...
export const userRouter = createTRPCRouter({
    ...
    getUserByName: protectedProcedure.input(inputGetById).query(async ({ input }) => {
